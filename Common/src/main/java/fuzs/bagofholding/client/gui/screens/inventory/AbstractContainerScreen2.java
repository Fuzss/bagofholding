...
public abstract class AbstractContainerScreen2<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
    ...
    public AbstractContainerScreen2(T abstractContainerMenu, Inventory inventory, Component component) {
...
//        super.render(poseStack, mouseX, mouseY, partialTick);
    ...
    private void renderSlot(PoseStack poseStack, Slot slot) {
        ...
        if (slot == this.clickedSlot && !this.draggingItem.isEmpty() && this.isSplittingStack && !itemStack.isEmpty()) {
            ...
            if (BagItemMenu.canItemQuickReplace(slot, itemStack2, true) && this.menu.canDragTo(slot)) {
                itemStack = itemStack2.copy();
                bl = true;
                BagItemMenu.getQuickCraftSlotCount(
                        this.quickCraftSlots, this.quickCraftingType, itemStack, slot.getItem().isEmpty() ? 0 : slot.getItem().getCount(), slot
                );
        ...
        if (!itemStack.isEmpty() && this.isQuickCrafting) {
            if (this.quickCraftingType == 2) {
                ...
                for(Slot slot : this.quickCraftSlots) {
                    ...
                    BagItemMenu.getQuickCraftSlotCount(this.quickCraftSlots, this.quickCraftingType, itemStack2, i, slot);
    ...
    public boolean mouseDragged(double mouseX, double mouseY, int button, double dragX, double dragY) {
        ...
        if (this.clickedSlot != null && this.minecraft.options.touchscreen().get()) {
            if (button == 0 || button == 1) {
                ...
                } else if (this.draggingItem.getCount() > 1 && slot != null && BagItemMenu.canItemQuickReplace(slot, this.draggingItem, false)) {
                    long l = Util.getMillis();
                ...
                && BagItemMenu.canItemQuickReplace(slot, itemStack, true)
        ...
        if (this.doubleclick && slot != null && button == 0 && this.menu.canTakeItemForPickAll(ItemStack.EMPTY, slot)) {
                ...
                if (!this.lastQuickMoved.isEmpty()) {
                    for(Slot slot2 : this.menu.slots) {
                        if (slot2 != null
                                ...
                                && BagItemMenu.canItemQuickReplace(slot2, this.lastQuickMoved, true)) {
            ...
            if (this.clickedSlot != null && this.minecraft.options.touchscreen().get()) {
                if (button == 0 || button == 1) {
                    ...
                    boolean bl2 = BagItemMenu.canItemQuickReplace(slot, this.draggingItem, false);
