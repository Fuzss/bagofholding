...
public class BagUpgradeRecipe extends ShapedRecipe {
    ...
    public ItemStack assemble(CraftingContainer container, RegistryAccess registryAccess) {
        ...
        ItemStack resultItem = super.assemble(container, registryAccess);
    ...
    public static class Serializer extends ShapedRecipe.Serializer {
        ...
        public ShapedRecipe fromJson(ResourceLocation recipeId, JsonObject jsonObject) {
            ...
            return new BagUpgradeRecipe(recipe.getId(), recipe.getGroup(), recipe.category(), recipe.getWidth(), recipe.getHeight(), recipe.getIngredients(), recipe.getResultItem(null));
        }
